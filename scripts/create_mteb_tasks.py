...
retri_eval should grow to also benchmark metrics important for production, e.g. latency and cost.
...
def main():
    ...
    output = ["# DO NOT MODIFY: Generated by scripts/create_mteb_tasks.py"]
    names = []
    output.append("from retri_eval.evaluation.indexed_task import IndexedTask")
    output.append("")
